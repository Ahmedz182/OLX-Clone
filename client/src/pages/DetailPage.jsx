...
const DetailPage = () => {
  ...
  const detail = Mobile.find((mobile) => mobile.id === localId);
  ...
  useEffect(() => {
    ...
    const getId = () => {
      ...
      const index = url.indexOf("/Mobile/") + "/Mobile/".length;
    ...
    <>
      <div className="flex  sm:flex-col md:flex-col overflow-hidden">
        ...
        <div>
          {detail && (
            <>
              <div className="outline ps-5 outline-2 rounded outline-grey p-3 sm:w-[90dvw] md:w-[90dvw] flex gap-4 sm:ms-8 md:ms-8 sm:justify-center  mt-8 sm:mt-0 md:mt-0 items-center ">
                <img
              ...
              <div className="outline outline-2 ps-5 rounded flex flex-col text-text outline-grey p-2 sm:w-[90dvw] md:w-[90dvw]  gap-4 sm:ms-8 md:ms-8  mt-8 sm:mt-0 md:mt-0  ">
